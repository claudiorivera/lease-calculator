...
CREATE TABLE "Lease" (
    ...
    "allowedMiles" INTEGER NOT NULL,
    "excessFeePerMileInCents" INTEGER NOT NULL,
    "userId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "OdometerReading" ADD CONSTRAINT "OdometerReading_leaseId_fkey" FOREIGN KEY ("leaseId") REFERENCES "Lease"("id") ON DELETE CASCADE ON UPDATE CASCADE;
