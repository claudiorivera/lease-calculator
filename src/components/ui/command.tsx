...
>(({ className, ...props }, ref) => (
	<CommandPrimitive.Item
		ref={ref}
		className={cn(
			"relative flex cursor-default select-none items-center rounded-xs px-2 py-1.5 text-sm outline-hidden aria-selected:bg-neutral-100 aria-selected:text-neutral-900 data-disabled:pointer-events-none data-disabled:opacity-50 dark:aria-selected:bg-neutral-800 dark:aria-selected:text-neutral-50",
			className,
		)}
		{...props}
	/>
